...
public class InterpretDrawingFile {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		if (shapeType.equals("ellipse")) {
			...
			double [] arrayOne = {parameterOne, parameterThree, parameterFive};
			double [] arrayTwo = {parameterTwo, parameterFour, parameterSix};
			
			if (isFilled == true) {
				StdDraw.filledPolygon(arrayOne, arrayTwo);
			}
			else {
				StdDraw.polygon(arrayOne, arrayTwo);
			}
		}
